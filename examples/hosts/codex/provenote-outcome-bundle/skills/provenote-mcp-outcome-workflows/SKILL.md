...
description: Use Notebooklab through the first-party MCP server from a Codex starter bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local Codex users one tracked starter bundle for Notebooklab's existing MCP outcome surfaces.
...
- not an official Codex integration or OpenAI endorsement claim
