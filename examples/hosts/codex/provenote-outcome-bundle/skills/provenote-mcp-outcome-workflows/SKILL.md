...
description: Use Provenote through the first-party MCP server from a Codex starter bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local Codex users one tracked starter bundle for Provenote's existing MCP outcome surfaces.
