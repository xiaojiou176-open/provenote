# Notebooklab Codex Starter Bundle

This is a tracked public-ready starter bundle for Codex-style MCP usage.

It exists to make Notebooklab easier to wire into Codex from a public Git-backed package path without pretending there is already a listed Codex plugin, marketplace package, or official OpenAI integration surface.
...
2. Confirm `notebooklab-mcp` is available in the environment that launches Codex.
