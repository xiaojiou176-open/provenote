...
description: Use Provenote through the first-party MCP server from a Codex-style local bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local hosts a Codex-style bundle that still keeps Provenote in the compatibility bucket.
