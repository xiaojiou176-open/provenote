...
description: Use Provenote through the first-party MCP server from a Cursor-style local bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local hosts a Cursor-style bundle that still keeps Provenote in the compatibility bucket.
