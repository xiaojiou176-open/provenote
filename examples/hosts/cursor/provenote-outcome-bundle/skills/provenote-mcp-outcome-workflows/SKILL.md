...
description: Use Provenote through the first-party MCP server from a Cursor starter bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local Cursor users one tracked starter bundle for Provenote's existing MCP outcome surfaces.
