...
description: Use Notebooklab through the first-party MCP server from an OpenCode starter bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local OpenCode users one tracked starter bundle for Notebooklab's existing MCP outcome surfaces.
...
- not an official OpenCode integration or affiliation claim
