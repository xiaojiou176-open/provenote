...
description: Use Provenote through the first-party MCP server from an OpenCode starter bundle without overclaiming plugin, marketplace, or public skills support.
---

# Purpose

Give local OpenCode users one tracked starter bundle for Provenote's existing MCP outcome surfaces.
