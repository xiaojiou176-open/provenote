...
def get_database_url():
    """Get database URL from single runtime contract."""
    return get_settings().surreal_url


def get_database_password():
    """Get database password from single runtime contract."""
    return get_settings().surreal_password


def get_database_namespace() -> str:
    """Get namespace with backward compatibility defaults."""
    return get_settings().surreal_namespace


def get_database_name() -> str:
    """Get database name with backward compatibility defaults."""
    return get_settings().surreal_database
