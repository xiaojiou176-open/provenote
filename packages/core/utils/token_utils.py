...
from packages.core.config import TIKTOKEN_CACHE_DIR
...
def token_count(input_string: str) -> int:
    ...
    try:
        ...
        # Fallback covers missing tiktoken and offline/cache download failures
        # without swallowing unrelated programming errors.
        from loguru import logger

        logger.warning(
            "tiktoken unavailable, falling back to word-count estimation: {}", exc
        )
