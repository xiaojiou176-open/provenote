    ...
    (set, get) => ({
      ...
      checkAuthRequired: async () => {
        try {
          ...
          appLog.error("auth-store", "Failed to check auth status", error);
      ...
      login: async (password: string) => {
        ...
        try {
          ...
          appLog.error("auth-store", "Network error during auth", error);
          let errorMessage = "Authentication failed";
      ...
      checkAuth: async () => {
        ...
        try {
          ...
          appLog.error("auth-store", "checkAuth failed", error);
          set({
            isAuthenticated: false,
            token: null,
            lastAuthCheck: null,
