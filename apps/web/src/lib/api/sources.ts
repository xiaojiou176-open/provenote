...
export const sourcesApi = {
  ...
  processingReport: async (id: string) => {
    const response = await apiClient.get<SourceProcessingReportResponse>(
      `/sources/${id}/processing-report`,
    );
    return response.data;
  },
  ...
  reprocess: async (id: string) => {
    const response = await apiClient.post<SourceResponse>(`/sources/${id}/reprocess`);
    return response.data;
  },
