export const zhTWCore = {
  common: {
    ...
    accessibility: {
      ...
      openSidebarNavigation: "開啟側邊欄導覽",
      expandSidebarNavigation: "展開側邊欄導覽",
      collapseSidebarNavigation: "收合側邊欄導覽",
    },
    url: "URL",
    errorDetails: "錯誤詳情",
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Notebooklab API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  notebooks: {
    ...
    draftsTitle: "草稿",
    draftsDescription: "從選取的來源建立 notebook 級可下載草稿，形成可重用的成果層。",
    draftTitlePlaceholder: "草稿標題（可選）",
    draftSourceSelection: "來源選擇",
    draftSelectAll: "全選",
    draftClearSelection: "清空選擇",
    draftNoSources: "請先將來源加入此筆記本，再建立草稿。",
    draftCreate: "建立草稿",
    draftCreateSuccess: "草稿建立成功",
    draftRerunSuccess: "草稿重跑成功",
    draftVerifySuccess: "草稿已標記為已驗證",
    noDraftsYet: "暫無草稿",
    createFirstDraft: "從選取的 notebook 來源生成第一份草稿，建立可重用的成果層。",
  },
  sources: {
    title: "來源",
    add: "新增來源",
    ...
    selectMultipleFilesHint:
      "選擇多個檔案進行批次導入。支援：文件 (PDF, DOC, DOCX, PPT, XLS, EPUB, TXT, MD)，媒體 (MP4, MP3, WAV, M4A)，圖片 (JPG, PNG)，歸檔 (ZIP)",
    selectedFiles: "已選擇檔案：",
  ...
  podcasts: {
    ...
    howTemplatesPowerDesc:
      "模板將播客工作流拆分為兩個可重複使用的構建塊。在生成新單集時可以隨時混合搭配它們。",
