...
export function WizardContainer({
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-[500px] min-w-0 overflow-hidden bg-card rounded-lg border border-border",
        className,
      )}
    >
      ...
      <div className="flex-1 min-w-0 overflow-hidden">
        <div className="h-full min-w-0 overflow-y-auto px-6 py-4">{children}</div>
      </div>
    </div>
  );
}
