...
export function LanguageLoadingOverlay() {
  ...
  return (
    <div
      className="ui-language-overlay fixed inset-0 z-[9999] flex items-center justify-center bg-background/80 backdrop-blur-sm"
      style={{ opacity: isChanging ? 1 : 0 }}
    >
      <div className="ui-language-overlay-content flex flex-col items-center gap-3">
