...
export function ContextIndicator({
  ...
  if (!hasContext) {
    return (
      <div
        className={cn("flex-shrink-0 text-xs text-muted-foreground py-2 px-3 border-t", className)}
      >
  ...
  return (
    <div
      className={cn(
        "flex-shrink-0 flex items-center justify-between gap-2 py-2 px-3 border-t bg-muted/30",
        className,
      )}
    >
