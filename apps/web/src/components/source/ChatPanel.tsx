...
import { Bot, Clock, FileText, Lightbulb, Loader2, Send, StickyNote, User } from "lucide-react";
...
export function ChatPanel({
  ...
  // Auto-scroll when a message is added or streaming updates the latest message.
  useEffect(() => {
    ...
    const behavior: ScrollBehavior = isStreaming || prefersReducedMotion ? "auto" : "smooth";
            ...
            <Dialog open={sessionManagerOpen} onOpenChange={setSessionManagerOpen}>
              ...
              <DialogContent className="sm:max-w-[420px] p-0 overflow-hidden">
                ...
                <DialogDescription className="sr-only">
                  Manage chat sessions, switch active sessions, and rename or remove saved
                  conversations.
                </DialogDescription>
                <SessionManager
                  sessions={sessions}
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              ...
              {contextIndicators.insights?.length > 0 && (
                <Badge variant="outline" className="gap-1">
                  ...
                  {contextIndicators.insights.length === 1 ? t.common.insight : t.common.insights}
                </Badge>
              )}
              {contextIndicators.notes?.length > 0 && (
                <Badge variant="outline" className="gap-1">
                  ...
                  {contextIndicators.notes.length === 1 ? t.common.note : t.common.notes}
                </Badge>
              )}
            </div>
          </div>
