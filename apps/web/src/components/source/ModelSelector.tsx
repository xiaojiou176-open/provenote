  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm" disabled={disabled} className="ui-icon-button gap-2">
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>{t.transformations.overrideModelDesc}</DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="flex justify-between">
          <Button variant="outline" className="ui-icon-button" onClick={handleReset}>
            {t.common.resetToDefault}
          </Button>
          <Button className="ui-primary-cta" onClick={handleSave}>
