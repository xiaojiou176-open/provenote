...
import { BookOpen, Check, LoaderIcon } from "lucide-react";
...
export function NotebookAssociations({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      appLog.error("notebook-associations", "Failed to save notebook associations", error);
    } finally {
      setIsSaving(false);
    }
  };
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <h4 className="font-medium text-sm truncate">{notebook.name}</h4>
