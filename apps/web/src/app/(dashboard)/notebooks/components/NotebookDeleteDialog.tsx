...
export function NotebookDeleteDialog({
  ...
  const {
    ...
    error: previewError,
  } = useNotebookDeletePreview(notebookId, open);
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        ...
        <div className="py-4 space-y-3">
          {isLoadingPreview ? (
            ...
            <div className="text-sm text-destructive">
              {t.common.error}: {previewError.message || t.common.refreshPage}
            </div>
          ) : preview ? (
            <>
              {/* Notes section */}
        ...
        <AlertDialogFooter>
          <AlertDialogCancel className="ui-icon-button" disabled={isDeleting}>
            {t.common.cancel}
          </AlertDialogCancel>
          <AlertDialogAction
            ...
            className="ui-primary-cta bg-red-600 hover:bg-red-700"
          >
            {isDeleting ? (
              <>
