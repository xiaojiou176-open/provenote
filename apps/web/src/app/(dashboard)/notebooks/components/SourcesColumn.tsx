...
import { ChevronDown, FileText, Link2, Loader2, Plus } from "lucide-react";
...
export function SourcesColumn({
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      appLog.error("sources-column", "Failed to delete source", {
        sourceId: sourceToDelete,
        error,
      });
    }
  };
  ...
  const handleRemoveConfirm = async () => {
    ...
    try {
      ...
      appLog.error("sources-column", "Failed to remove source from notebook", {
        notebookId,
        sourceId: sourceToRemove,
        error,
      });
  ...
  const handleRetry = async (sourceId: string) => {
    try {
      ...
      appLog.error("sources-column", "Failed to retry source", { sourceId, error });
    }
  };
