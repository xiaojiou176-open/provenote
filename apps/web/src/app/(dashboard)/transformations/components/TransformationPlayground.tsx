...
export function TransformationPlayground({
  ...
  const handleExecute = async () => {
    if (executeTransformation.isPending || !selectedId || !modelId || !inputText.trim()) {
      return;
    }
    ...
    try {
      ...
      appLog.error("transformation-playground", "Failed to execute transformation", {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t.transformations.desc}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-center">
            <Button
              ...
              disabled={!canExecute}
              aria-busy={executeTransformation.isPending}
          ...
          {output && (
            <div className="ui-section-enter space-y-2">
              <span className="text-sm font-medium leading-none">
                {t.transformations.outputLabel}
              </span>
              <Card>
