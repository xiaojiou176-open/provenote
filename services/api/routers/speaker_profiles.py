...
from packages.core.podcasts.models import SpeakerProfile
...
async def create_speaker_profile(profile_data: SpeakerProfileCreate):
    ...
    try:
        tts_provider = _assert_google_provider(
            profile_data.tts_provider, "tts_provider"
        )
...
async def update_speaker_profile(profile_id: str, profile_data: SpeakerProfileCreate):
    ...
    try:
        ...
        profile.tts_provider = tts_provider
