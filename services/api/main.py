...
def assert_no_legacy_provider_env() -> None:
    ...
    raise RuntimeError(
        ...
        "Recommended GEMINI_MODEL strategy: keep it unset unless you need a specific override, or set it to a currently available Gemini language model. "
...
app.include_router(research_threads.router, prefix="/api", tags=["research-threads"])
